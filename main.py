...
"""
--- Sample Run #1 ---
Welcome to the airbnb database! To get started, please enter your name: Will
Welcome Will! Enter /help or enter a header: -== The Finished Product! ==-
Please enter your home currency: USD
Loading Will's currency table...
...
-- Copyright © 2021 by William Tholke -- 
...
8 - Load Data
9 - Quit
Please input a choice from the menu above: 1
...
9 - Quit
Please load data.
Please input a choice from the menu above: 8
...
8 - Load Data
9 - Quit
Please input a choice from the menu above: 2
...
8 - Load Data
9 - Quit
Please input a choice from the menu above: 3
...
8 - Load Data
9 - Quit
Please input a choice from the menu above: 4
...
8 - Load Data
9 - Quit
Please input a choice from the menu above: 5
...
8 - Load Data
9 - Quit
Please input a choice from the menu above: 6
...
8 - Load Data
9 - Quit
Please input a choice from the menu above: 9
